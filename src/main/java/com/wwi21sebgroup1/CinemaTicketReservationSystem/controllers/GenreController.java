...
public class GenreController {
    ...
    @PutMapping("/add")
    public void addGenre(@RequestBody GenreRequest genreRequest){genreService.addGenre(genreRequest);}

    @PutMapping("/update:{oldGenreName}")
    public void updateGenre(@PathVariable String oldGenreName, @RequestBody GenreRequest genreRequest){genreService.updateGenre(oldGenreName, genreRequest);}
    ...
    @GetMapping("/all")
    public @ResponseBody Iterable<Genre> getGenres(){return genreService.getGenres();}
}